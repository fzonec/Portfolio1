...
const translations = {
  fr: {
    ...
    subtitle:
      "Actuellement en recherche d’opportunités pour développer mes compétences en administration systèmes et réseaux. N’hésitez pas à me contacter.",
    locationTitle: "Localisation",
    locationCity: "Nanterre 92000, France",
    locationRegion: "Île-de-France",
    availabilityTitle: "Disponibilité",
    availabilityText: "En alternance",
    availabilityPeriod: "BTS SIO SISR 2025-2027",
  ...
  en: {
    ...
    subtitle:
      "Currently looking for opportunities to develop my skills in systems and network administration. Feel free to contact me.",
    locationTitle: "Location",
    locationCity: "Nanterre 92000, France",
    locationRegion: "Ile-de-France",
    availabilityTitle: "Availability",
    availabilityText: "In apprenticeship",
    availabilityPeriod: "BTS SIO SISR 2025-2027",
    cta: "Send a message",
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              ...
              <div className="text-left p-6 bg-secondary/30 rounded-2xl">
                ...
                <h3 className="font-semibold mb-1">{t.availabilityTitle}</h3>
                <p className="text-muted-foreground">{t.availabilityText}</p>
                <p className="text-sm text-muted-foreground mt-1">
                  {t.availabilityPeriod}
                </p>
              </div>
            </div>
